...
pub fn cross(t1: Tuple, t2: Tuple) -> Tuple {
    [t1[1]*t2[2] - t1[2]*t2[1], t1[2]*t2[0] - t1[0]*t2[2], t1[0]*t2[1] - t1[1]*t2[0], 0.]
}
...
mod tests {
    ...
    #[test]
    fn test_is_point() {
        assert_eq!(is_point([1., 2., 3., 1.]), true);

        assert_eq!(is_point([1., 2., 3., 0.]), false);
    }

    #[test]
    fn test_is_equal() {
        assert_eq!(is_equal([1., 2., 3., 0.], [1., 2., 3., 0.]), true);
        assert_eq!(is_equal([1., 2., 3., 0.], [1.000005, 1.999995, 2.999995, 0.]), true);
